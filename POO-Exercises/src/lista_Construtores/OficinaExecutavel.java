...
public class OficinaExecutavel {
	...
	public static void main(String[] args) {
		...
		// Ferramenta elétrica ( modelo - fabricante - peso - desgaste - rpm - potencia - volts)
		...
		Martelo m1 = new Martelo("Madeira", "Tramontina", 0.633, 0.5, "Básico", 1200);
		Martelo m2 = new Martelo("Fibra", "Vonder", 0.454, 0.5, "Básico", 1500); // milimetros
		...
		System.out.println("O Total mensal é: " + ((f1.CalculaConsumo(3) + l1.CalculaConsumo(2) + s1.CalculaConsumo(4)) * 7) * 30);
		
		System.out.println("------------------------------");
		
		System.out.println("Ferramenta manual com mais vida útil: Alicate e Martelo");
		
		System.out.println("A vida útil da Alicate é: " + a1.CalculaVida() + " horas ");
		System.out.println("A vida útil do Martelo 1 é: " + m1.CalculaVida() + " horas ");
		System.out.println("A vida útil do Serrote é: " + serrote.CalculaVida() + " horas ");
		
		System.out.println("------------------------------");
		
		System.out.println("A vida útil da Alicate é: " + a1.CalculaVida("dia") + " dias ");
		System.out.println("A vida útil do Martelo é: " + m1.CalculaVida("dia") + " dias ");
		
		System.out.println("-------------------------------");
		
		System.out.println("A vida útil da Alicate é: " + a2.CalculaVida("semana") + " semana ");
		System.out.println("A vida útil do Martelo é: " + m1.CalculaVida("semana") + " semana ");
